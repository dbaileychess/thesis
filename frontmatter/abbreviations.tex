\begin{longtable}{@{}p{4cm}@{}p{\dimexpr\textwidth-1cm\relax}@{}}
...
\nomen{NCE}{Nomalized collision energy}
...
\nomen{Th}{Thomson, a unit of the mass-to-charge ratio}
\nomen{TIC}{Total-ion chromatogram}
\nomen{TMT}{Tandem mass tags}
\nomen{XIC}{Extrated-ion chromatogram}
\nomen{\emph{z}}{Charge}
\end{longtable}